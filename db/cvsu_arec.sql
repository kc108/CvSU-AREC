...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 08, 2019 at 11:03 PM
...
(33, 4, 16, 'wwwwwww', '2019-07-08 02:16:10'),
(34, 4, 16, 'zzzz', '2019-07-08 02:56:10'),
(35, 4, 16, 'dsdsd', '2019-07-08 02:58:06'),
(36, 4, 16, 'dddd', '2019-07-08 02:58:14');
...
INSERT INTO `notification` (`notif_ID`, `user_ID`, `notif_Msg`, `notif_Date`, `notif_Type`, `notif_State`) VALUES
(1, 4, 'New Research Added ', '2019-07-08 19:04:52', 1, NULL),
(3, 4, 'New Research Added: (a3123123)', '2019-07-08 19:25:59', 1, NULL),
(5, 4, 'a3123123 Approved', '2019-07-08 19:51:19', 2, 1),
(6, 4, 'a3123123 Archive', '2019-07-08 19:57:02', 2, 1),
(7, 4, 'a3123123 Disapprove', '2019-07-08 19:57:42', 2, 1),
(8, 16, 'a3123123 Approved', '2019-07-08 19:51:19', 2, 1),
(9, 16, 'Biogas Purification Approved', '2019-07-08 21:02:01', 2, NULL);
...
CREATE TABLE `research` (
  ...
  `research_yrConduct` year(4) NOT NULL,
  `status_ID` tinyint(4) UNSIGNED DEFAULT NULL,
  `research_Created` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `research_Attachment` text,
  `research_AttchMIME` varchar(255) DEFAULT NULL,
  `research_AttchData` longblob
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `research` (`research_ID`, `user_ID`, `research_Title`, `research_Content`, `research_yrConduct`, `status_ID`, `research_Created`, `research_Attachment`, `research_AttchMIME`, `research_AttchData`) VALUES
(25, 16, 'Pilot Commercialization of Community-Based Jatropha Plant Oil Extraction Facility in ', 'Conduct R&D on RE resources and technologies', 2008, 1, '2006-12-31 19:14:26', NULL, '', ''),
(26, 16, 'Technology Validation of Biogas Technology and Its Utilization in the Philippines', 'Conduct R&D on RE resources and technologies', 2008, 1, '2006-12-31 16:00:00', NULL, '', ''),
(27, 16, 'Waste to Energy Conversion in Agriculture', 'Conduct R&D on RE resources and technologies', 2008, 1, '2006-12-31 19:14:26', NULL, '', ''),
(28, 16, 'A Project Feasibility Study on the Manufacture of Bio-Diesel Fuel', 'Conduct R&D on RE resources and technologies', 2008, 1, '2006-12-31 19:14:26', NULL, '', ''),
(29, 16, 'Socio-Economic Impact Evaluation of Barangay Electrification Projects (BEPs) of Cavit', 'Conduct of surveys on the following barangay beneficiaries: (a) Bgy. Tagumpay, Real, Quezon, (b) Bgy. Masikap, Real, Quezon, (c) Bgy. Harisson, Paluan, Occidental Mindoro', 2008, 1, '2008-12-31 19:14:26', NULL, '', ''),
(30, 16, 'Comparative Performance Evaluation of Locally-Made and Imported Biogas-Powered Genera', 'Conducted to determine the efficiency of existing locally-made and imported biogas generators as source of electricity', 2008, 1, '2011-12-31 19:14:26', NULL, '', ''),
(31, 16, 'Evaluation of Gas and Wastewater Quality from Biogas Using Different Animal Manures', 'Conducted to evaluate the gas and wastewater quality produced from different animal manures (chicken, cow, pig)', 2008, 1, '2012-12-31 19:14:26', NULL, '', ''),
(32, 16, 'Development and Evaluation of Low-Cost Battery Control Unit (BCU)', 'Conducted to develop a low-cost and durable BCU which could replace the costly BCUs available in the market', 2008, 1, '2012-12-31 19:14:26', NULL, '', ''),
(33, 16, 'Biogas Purification', 'Conducted to evaluate different biogas purification systems for the improvement of biogas quality', 2008, 2, '2012-12-31 19:14:26', NULL, '', ''),
(34, 16, 'Biogas Technology Assessment in the Philippines', 'Conducted to assess the existing biogas technology in the Philippines', 2008, 2, '2012-12-31 19:14:26', NULL, '', ''),
(35, 4, '', '', 0000, 0, '2019-07-08 05:37:55', '', '', '');
...
(16, 1, NULL, 'researcher', 'CkpKeaNXiLAYD2rJvtY4tof5bJG0fsf1kVghCSMgvwM=', 'asd3512@gmail.com', '2019-03-28 17:14:25', 1),
(18, 1, NULL, '19874546', 'E+5/EWa+nTAxJpMU6AZv4idgMlXBalZ/a4+zYEC9Np8=', 'asdasdasd@gmail.com', '2019-04-16 05:06:10', 1),
...
--
ALTER TABLE `message`
  MODIFY `message_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
--
...
--
ALTER TABLE `notification`
  MODIFY `notif_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `research`
  MODIFY `research_ID` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
--
